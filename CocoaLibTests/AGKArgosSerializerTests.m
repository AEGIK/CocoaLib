...
#import "AGKArgosSerializerTests.h"
...
@synthesize serializer = _serializer, deserializer = _deserializer;
...
- (void)testSerializeDouble
{
	...
	uint8_t b[] = { AGKArgosProtocolDoubleZero };
...
- (void)testSerializeBool
{
	...
	uint8_t b1[] = { AGKArgosProtocolFalse };
	[self compare:[NSNumber numberWithBool:NO] bytes:b1 length:1]; 	
	uint8_t b2[] = { AGKArgosProtocolTrue };
